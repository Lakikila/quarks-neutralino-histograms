...
// Fri Jun 25 19:37:17 2021 by ROOT version 6.22/08
// from TTree trees_SRRPV_/trees_SRRPV_
// found on file: 403615.root
//////////////////////////////////////////////////////////

#ifndef quark_to_fjet_matching_h
#define quark_to_fjet_matching_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   quark_to_fjet_matching(TTree *tree=0);
   virtual ~quark_to_fjet_matching();
...
#ifdef quark_to_fjet_matching_cxx
quark_to_fjet_matching::quark_to_fjet_matching(TTree *tree) : fChain(0) 
{
...
quark_to_fjet_matching::~quark_to_fjet_matching()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t quark_to_fjet_matching::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t quark_to_fjet_matching::LoadTree(Long64_t entry)
{
...
void quark_to_fjet_matching::Init(TTree *tree)
{
...
Bool_t quark_to_fjet_matching::Notify()
{
...
void quark_to_fjet_matching::Show(Long64_t entry)
{
...
Int_t quark_to_fjet_matching::Cut(Long64_t entry)
{
...
#endif // #ifdef quark_to_fjet_matching_cxx
